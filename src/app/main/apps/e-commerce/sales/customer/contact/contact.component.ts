...
export class ContactComponent implements OnInit {
  ...
  ngOnInit() {
    this.currentPrimaryContact = this.persons.filter(s => s._id == this.customer.primaryContactPersonID._id)[0];
    this.currentAlternateContact = this.persons.filter(s => s._id == this.customer.alternateContactPersonID._id)[0];
